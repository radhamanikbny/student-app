class StudentProfilesController < ApplicationController
  ...
  def create
    @student = Student.find(params[:student_profile][:student_id])
    @student_profile = @student.build_student_profile(student_profile_params)
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:email, :address, :age, :mobile, :image, :student_id)
    end
end

...
class StudentProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post student_profiles_url, params: { student_profile: { address: @student_profile.address, age: @student_profile.age, email: @student_profile.email, image: @student_profile.image, mobile: @student_profile.mobile, student_id: @student_profile.student_id } }
    end
  ...
  test "should update student_profile" do
    patch student_profile_url(@student_profile), params: { student_profile: { address: @student_profile.address, age: @student_profile.age, email: @student_profile.email, image: @student_profile.image, mobile: @student_profile.mobile, student_id: @student_profile.student_id } }
